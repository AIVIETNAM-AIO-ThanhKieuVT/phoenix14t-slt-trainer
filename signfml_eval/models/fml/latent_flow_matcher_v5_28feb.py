...
# -*- coding: utf-8 -*-
"""
Latent Flow Matcher V5 (28 Feb) — mBART-50 + Transformer Length Predictor
========================================================================
Author: SignFML Research
Date: 28 Feb 2026

Changes from V4:
    - Length Predictor: MLP (3-layer) → Transformer (2-layer + Attention Pooling)
    - Preparation for SCST: Enhanced sampling interfaces for RL-based fine-tuning.
"""
...
class LatentFlowMatcherV5(nn.Module):
    """
